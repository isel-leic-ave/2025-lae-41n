...
data class CourseExt(val name: String, val semester: Int,val  programme: String) {
}
data class CourseInternal(val name: String,val semester: Int, val programme: String) {}
...
fun mapper(src: Any, dstRep: KClass<*> ): Any? {
    ...
    fun getValueForParameter(parameter: KParameter): Any {
        val propRep = srcKProperties.first { it.name == parameter.name }
